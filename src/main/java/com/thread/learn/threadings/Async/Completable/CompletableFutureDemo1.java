...
public class CompletableFutureDemo1 {
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        CompletableFuture<Integer> futureLambda = CompletableFuture.supplyAsync(
                () -> {
                    System.out.println("Accessing customer loyalty points data over the network by lambda...");
                    try {
                        TimeUnit.SECONDS.sleep(4);
                    } catch (InterruptedException e) {
                        throw new RuntimeException(e);
        ...
        CompletableFuture<Integer> futureWithCallback = future.thenApply(
                result -> {
